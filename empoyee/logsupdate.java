...
public class logsupdate extends javax.swing.JFrame {
   ...
   jLabel3.setText(dtf.format(now));
    ...
    private void initComponents() {
        ...
        jLabel3.setBackground(new java.awt.Color(250, 237, 205));
  ...
  private void jButton1MouseEntered(java.awt.event.MouseEvent evt) {                                      
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(logsupdate.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new logsupdate().setVisible(true);
            }
        });
    }
